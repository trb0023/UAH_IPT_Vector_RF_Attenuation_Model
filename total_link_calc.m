function [data_rate] = total_link_calc(frequency, max_bandwidth_percent, altitude, elevation_angle, altitude_of_orbiter, lander_gain, orbiter_gain, transmit_power, noise_temperature, Eb_No, code_rate, misclosses)
